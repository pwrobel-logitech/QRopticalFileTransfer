...
CFLAGS_ARM=--sysroot=/home/pwrobel/Android/Sdk/ndk-bundle/platforms/android-24/arch-arm/ -I/home/pwrobel/Android/Sdk/ndk-bundle/platforms/android-24/arch-arm/usr/include -I/home/pwrobel/Android/Sdk/ndk-bundle/sources/android/support/include/ -O2 -I. -Wall
...
fec_arm_test: single_fac_test.cpp
	$(CPP_ARM) $(CFLAGS_ARM) -fPIE -pie single_fac_test.cpp -Wl,-rpath=\$$ORIGIN -o bin_fec_arm/test_single -L$(current_dir)/bin_fec_arm -lfec_arm
